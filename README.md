...
를 직접 실행할 수 있습니다. 가져오기 시 같은 폴더에 **`설치-체크리스트.html`** 도 생성되어,
winget이 자동 설치하지 못하는 **"직접 설치 필요"** 프로그램(한글·GPKI 등)과 자동 설치 대상을
체크박스로 구분해 보여줍니다(브라우저에 체크 상태 저장, 검색·인쇄 지원, 오프라인 동작). 시작프로그램은 `HKCU\...\Run` 항목과 사용자 시작프로그램 폴더
바로가기를 이전합니다.
